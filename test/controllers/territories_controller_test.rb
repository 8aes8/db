...
class TerritoriesControllerTest < ActionController::TestCase
  ...
  test "should create territory" do
    assert_difference('Territorie.count') do
      post :create, territory: { region_id: @territory.region_id, territory_description: @territory.territory_description }
    end
  ...
  test "should update territory" do
    patch :update, id: @territory, territory: { region_id: @territory.region_id, territory_description: @territory.territory_description }
    assert_redirected_to territory_path(assigns(:territory))
  end

  test "should destroy territory" do
    assert_difference('Territorie.count', -1) do
